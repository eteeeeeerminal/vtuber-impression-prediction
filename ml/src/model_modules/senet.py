...
__all__ = ['SENet', 'senet50', 'Bottleneck']

PRETRAINED_N_IDENTITY = 8631  # the number of identities in VGGFace2 for which ResNet and SENet are trained
...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers):
        ...
        self.feature_n = 512 * block.expansion

        self.fc = nn.Linear(self.feature_n, PRETRAINED_N_IDENTITY)
